const babyVaccinesSeed = [
    // At Birth (0 weeks)
    { name: "BCG", description: "Protects against severe forms of tuberculosis (TB), especially TB meningitis in infants.", sideEffects: "Small swelling or sore at injection site, mild fever, scar formation (normal).", ageInWeeks: 0, category: "baby", isDefault: true },
    { name: "OPV-0", description: "Oral Polio Vaccine that protects against poliovirus causing paralysis.", sideEffects: "Very mild fever or diarrhea (rare).", ageInWeeks: 0, category: "baby", isDefault: true },
    { name: "Hepatitis B-1", description: "Protects against hepatitis B virus affecting the liver.", sideEffects: "Soreness at injection site, mild fever.", ageInWeeks: 0, category: "baby", isDefault: true },
    // 6 Weeks
